...
public class AddDeviceAdapter extends RecyclerView.Adapter<AddDeviceAdapter.MyViewHolder> {
    ...
    List<NewDevice> mData;
    private int index = 0;
    public static String deviceID;

    public AddDeviceAdapter(List<NewDevice> mData) {
        this.mData = mData;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.textIp.setText(mData.get(position).getIp());
        holder.textMac.setText(mData.get(position).getMac());
